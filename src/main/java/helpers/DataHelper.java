...
public class DataHelper {
    ...
    public static String generateRandomName(){ return String.format("%s" , generateRandomString(10)); }
    ...
    public static String generateRandomCommentName(){
        return String.format("%s" , generateRandomString(25));
    }
